...
Step 1b: copy kxm180046_p3.zip to <netid>@dc01.utdallas.edu:/<some>/<dir>/

Step 1c: in terminal1, ssh onto <netid>@dc01.utdallas.edu

Step 1d: change directory to /<some>/<dir>/ in terminal1

Step 1e: unzip kxm180046_p3.zip

Step 1f: change directory to /<some>/<dir>/kxm180046_p3/

Step 1g: run command in terminal1: `make clean`

Step 1h: run command in terminal1: `make`

Step 1i: in terminal1, check the directory /<some>/<dir>/kxm180046_p3/ and it will show THREE dir: {0,1,2}
...
Step 4b: change directory to /<some>/<dir>/kxm180046_p3/ in terminal
...
Step 5b: change directory to /<some>/<dir>/kxm180046_p3/ in terminal
...
STEP 7a: in any of the client terminal, check that how there EXISTS THREE directory `/<some>/<dir>/kxm180046_p3/{0,1,2}` and it contains THREE files, `T1.txt` , `T2.txt`, and `T3.txt`.

Step 7b: in any of the client terminal type `diff /<some>/<dir>/kxm180046_p3/0 /<some>/<dir>/kxm180046_p3/1` and you will see that there is NO OUTPUT, thus proving that `0` and `1` are the same directory and they contain the same contents

Step 7c: in any of the client terminal type `diff /<some>/<dir>/kxm180046_p3/0 /<some>/<dir>/kxm180046_p3/2` and you will see that there is NO OUTPUT, thus proving that `0` and `2` are the same directory and they contain the same contents
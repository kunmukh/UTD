; ModuleID = 'cs6332.001-f20-assign0x5-master/fib/instFib.ll'
...
@.str5 = private unnamed_addr constant [11 x i8] c"FIB_LOGGER\00", align 1
@.str16 = private unnamed_addr constant [14 x i8] c"call fib(%d)\0A\00", align 1
@.str27 = private unnamed_addr constant [18 x i8] c"fib() returns %d\0A\00", align 1
...
return:                                           ; preds = %if.end, %if.then
  %6 = load i32* %retval
  %7 = call i32 @fib_logger(i32 %i, i32 0)
  ret i32 %6
}
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @strtol(i8* %5, i8** %end, i32 10) #6
...
if.end24:                                         ; preds = %if.end19
  ...
  %22 = call i32 @fib_logger(i32 %argc, i32 1)
  %call25 = call i32 @fib(i32 %21)
  store i32 %call25, i32* %value, align 4
  %23 = load i32* %value, align 4
  %call26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0), i32 %23)
  call void @exit(i32 0) #5
  unreachable

return:                                           ; No predecessors!
  %24 = load i32* %retval
  %25 = call i32 @fib_logger(i32 %argc, i32 0)
  ret i32 %24
}
...
entry:
  ...
  %call = call i8* @getenv(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0)) #6
  %call1 = call i32 @atoi(i8* %call) #8
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([14 x i8]* @.str16, i32 0, i32 0), i8** %fmt, align 4
  br label %if.end4

if.else:                                          ; preds = %if.end
  store i8* getelementptr inbounds ([18 x i8]* @.str27, i32 0, i32 0), i8** %fmt, align 4
  br label %if.end4

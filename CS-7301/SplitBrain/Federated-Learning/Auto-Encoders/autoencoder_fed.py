...
class SimpleMLP:
    ...
    def build(shape, classes):
        ...
        encoding_dim = int(shape / 2)
        hidden_dim = int(encoding_dim / 2)

        model = Sequential()
        model.add(Dense(encoding_dim, input_shape=(shape,)))
...
# https://github.com/datafrick/tutorial/blob/master/fl_implemetation.py
def main():
    print('PID: ', os.getpid())
    ...
    fu.driver(model, 'Federated', False)

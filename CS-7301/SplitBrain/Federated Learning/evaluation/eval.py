...
def main():
    ...
    print('VectorClient', pd.DataFrame(vectorClient))
    print('VectorUpdateClient', pd.DataFrame(vectorUpdateClient))
    print('VectorServer', pd.DataFrame(vectorServer))
    ...
    print('test corpus1', pd.DataFrame(testCorpus1))
    print('test corpus2', pd.DataFrame(testCorpus2))

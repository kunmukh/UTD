...
<div class="post">
	<div class="post-bgtop">
		...
		if (isset($_POST['submit'])) {
		    ...
		    $userinputtmp = mysql_real_escape_string($_POST['uname']);
		    $sqlinput = ["'", ";", ",", "#", "-", "&", "%", "|", "\\", "or ", "and ", "\""];
		    $userinput = str_replace($sqlinput, "", $userinputtmp);

            $passinputtmp = mysql_real_escape_string($passwordHash);
		    $passinput = str_replace($sqlinput, "", $passinputtmp);
            ...
            {
                mysql_query("INSERT INTO users (username, pass, fname, lname) VALUES ('". $userinput ."', '". $passinput ."', '". $_POST['fname']."', '". $_POST['lname'] ."');")or die(mysql_error());
